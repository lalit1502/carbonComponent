...
import {  storeProducts , getCategory, category } from '../data/data';
import CardGrid from './section/cardGrid';
import Slider from './section/homeSlider';
import MultiRangeSlider from "../components/multiRange";
import { inputProps , storeProductsProps } from "../components/interface"
        ...
        <Grid container spacing={2} sx={{ margin: '20px'}} >
            ...
            <Box sx={{ width: "100%", height:"auto" }} >
                ...
                <MultiRangeSlider
                    min={min}
                    max={max}
                    onChange={(e, { min, max })  => handleSearch1(min,max ) }
                /> */}
            </Box>
            </Grid>
            <Grid container  xs={9}>
